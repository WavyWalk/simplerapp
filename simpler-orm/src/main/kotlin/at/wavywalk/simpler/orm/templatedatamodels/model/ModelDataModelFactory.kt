...
object ModelDataModelFactory {
        ...
        for (associationBean in associationBeans) {
            ...
            if (associationBean.associationType == "BELONGS_TO_POLYMORPHIC") {
                associationBean.associatedPolymorphicModelDataModels.forEach {
                    ...
                    setToInject.add("${it.packagesBean.baseGenerated}.${it.modelClass}Merger")
            ...
            setToInject.add("${associationBean.associatedModelDataModel.packagesBean.baseGenerated}.${associationBean.associatedModelDataModel.modelClass}FromParamsSerializer")
            setToInject.add("${associationBean.associatedModelDataModel.packagesBean.baseGenerated}.${associationBean.associatedModelDataModel.modelClass}Merger")
    ...
    fun createDefaultUsing(element: Element, elementUtils: Elements): ModelDataModel {
        ...
        val shouldGenerateRequestParamsWrapper = getShouldGenerateRequestParamsWrapper(element)
        ...
        val modelDataModelToReturn =  ModelDataModel(
                ...
                shouldGenerateRequestParamsWrapper = shouldGenerateRequestParamsWrapper
        )
    ...
    private fun getShouldGenerateRequestParamsWrapper(element: Element): Boolean {
        val isModelAnnotation = element.getAnnotation(IsModel::class.java)
        return isModelAnnotation.generateRequestParamsWrapper
    }
