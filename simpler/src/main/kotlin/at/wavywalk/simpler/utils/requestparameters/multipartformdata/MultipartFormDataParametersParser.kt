...
class MultipartFormDataParametersParser: IRequestParametersParser {
    ...
    override fun parse(toParse: String?): IParam? {
        throw UnsupportedOperationException("${MultipartFormDataParametersParser::class.simpleName} does not support parsing from string")
    }
    ...
    fun defaultServletFileUploadOrInitialize(request: HttpServletRequest): ServletFileUpload {
        ...
        createServletFileUpload(1024 * 1024 * 10 * 10, request).let {
